...
parquet_path = "/home/rodrigofrancachaves/capp30122/group_project/project-datacenter-urban-effects/data/spatial_data/cities/ChicagoMetroArea.parquet"
...
files = [
    {
        "path": "data/energy and water data/nhgis0003_ds255_20215_zcta.csv",
        "year": "2021",
        "elec_prefix": "APCX",
        "water_prefix": "APCZ",
    },
    {
        "path": "data/energy and water data/nhgis0003_ds263_20225_zcta.csv",
        "year": "2022",
        "elec_prefix": "AREA",
        "water_prefix": "AREC",
    },
    {
        "path": "data/energy and water data/nhgis0003_ds268_20235_zcta.csv",
        "year": "2023",
        "elec_prefix": "ATE7",
        "water_prefix": "ATE9",
    },
    {
        "path": "data/energy and water data/nhgis0003_ds273_20245_zcta.csv",
        "year": "2024",
        "elec_prefix": "AVGI",
        "water_prefix": "AVGK",
    },
...
for cfg in files:
    ...
    # Filter to Chicago metro ZIPs only
    before = len(df)
...
# ── Save ──────────────────────────────────────────────────────────────────────
out_path = "data/energy and water data/nhgis_energy_water_wide.csv"
